...
<body>
	...
	<div class="container text-center mt-6">
		<form:form action="/savefeedback" method="post" modelAttribute="feedback" style="margin-left: 400px;">
		<table class="text-center">
			...
			<tr>
				<td><label for="Feedback" class="col-form-label col-10">
					<h5>Feedback :</h5>
				</label></td>
				<td><form:input path="Feedback" class="form-control col-12" /></td>
			</tr>
